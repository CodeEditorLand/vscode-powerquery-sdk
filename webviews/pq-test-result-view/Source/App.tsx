...
import {
	useVSCodeContextProps,
	VSCodeContextProvider,
} from "./contexts/VscodeContexts";
	...
	return (
		<div className="entry-container">
			<ThemeProvider theme={fluentTheme}>
				{!!latestPqTestResult &&
				Array.isArray(latestPqTestResult) &&
				latestPqTestResult.length ? (
					<TestBatteryResultView
						testRunExecution={latestPqTestResult[0]}
					/>
				) : null}
			</ThemeProvider>
		</div>
