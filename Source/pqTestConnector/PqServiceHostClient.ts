...
export class PqServiceHostClient
	extends PqServiceHostClientLite
	implements IPQTestService, IDisposable
{
	...
	>(
		...
		const responseResultPayload: PqServiceHostResponseResult["Payload"] =
			await super.requestRemoteRpcMethod(method, parameters, options);
