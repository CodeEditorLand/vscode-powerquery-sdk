...
export type ExtractEventTypes<EvtObjOrEvtProp> = EvtObjOrEvtProp extends Record<
...
export class DisposableEventEmitter<Event extends string | symbol>
	...
	implements IDisposable
{
	...
	dispose(): void {
		while (this.internalDisposables.length) {
			const disposable: IDisposable | undefined =
				this.internalDisposables.pop();
